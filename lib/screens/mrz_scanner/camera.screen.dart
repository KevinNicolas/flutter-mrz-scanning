...
class MrzCameraScreen extends StatefulWidget {
  const MrzCameraScreen({super.key});

  @override
  MrzCameraScreenState createState() => MrzCameraScreenState();
}

class MrzCameraScreenState extends State<MrzCameraScreen> {
  bool isParsed = false;
